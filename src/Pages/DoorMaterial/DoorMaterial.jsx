...
export default function DoorMaterial() {
  return (
    <section id="featured-categories" className="py-16 bg-gray-50">
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-neutral-600 mb-4">
                  ...
                  resist warping and offer excellent stability in varying
                  climate conditions.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-neutral-500">
          ...
          <div className="bg-neutral-800 rounded-lg p-8 text-center text-white">
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              Our expert consultants can help you select the perfect door
              material based on your specific needs, preferences, and budget.
            </p>
